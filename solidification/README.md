...
## 核生成と界面<a id="sec-1-1" name="sec-1-1"></a>

## 一方向凝固の濃度分布<a id="sec-1-2" name="sec-1-2"></a>

## 組成的過冷却と共晶凝固<a id="sec-1-3" name="sec-1-3"></a>

## 工業プロセスでの凝固現象<a id="sec-1-4" name="sec-1-4"></a>

## 補足(Gibbs-Thomson)<a id="sec-1-5" name="sec-1-5"></a>
