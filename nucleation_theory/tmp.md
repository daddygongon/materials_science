...
\label{Eq2}$$ と見積もられる[@KamijoFukutomi:1983]．
...
data-label="ClusterEnergy"></span>](./figs/ClusterEnergy.eps){width="75mm"}

![クラスターの自由エネルギー変化．<span
data-label="ClusterFreeEnergy"></span>](./figs/ClusterFreeEnergy.eps){width="75mm"}
...
![クラスターの場合の数．<span
data-label="SchemRotation"></span>](./figs/SchemRotation2.eps){width="35mm"}
