...
＼begin{description}
＼item[1.] 
　研究室のサーバには，グローバルアドレスを割り振っておらず，研究室で展開しているローカルエリアネットワーク内のPCからリモートログインし計算の発行が可能となる．
本稿では，研究室内のPCへリモートログインし，そのPCから再度，計算ホストへリモートログインし，計算の実行，検証までを説明する．＼＼
研究室のPCへログインする．下記のアカウント名とPasswordの欄には，配布したプリントに記載されているアカウント名とパスワードを入力する．
{＼scriptsize
＼begin{itembox}{ターミナル}
＼begin{verbatim}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=9cm]{./Figure/FLOW.jpg}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=14.0cm]{./Figure/POSCAR1.jpg}
＼caption{POSCARファイル}
＼end{center}
＼end{figure}
＼newpage
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[scale=0.5,bb=0 0 500 500]{./Figure/Si_EVcurve2.jpg}
＼caption{SiのE-V曲線}
＼label{E-V}
＼end{center}
＼end{figure}
...
＼item ＼textbf{cd}
＼begin{itemize}
＼item cdコマンドは，作業ディレクトリを指定したディレクトリに移動するためのコマンド．cd [ディレクトリ名]で指定したディレクトリに移動できる．コマンド名cdはChange Directoryに由来する．
＼end{itemize}
＼item ＼textbf{pwd}
＼begin{itemize}
＼item pwdコマンドは，現在作業中のディレクトリ，カレントディレクトリを表示させるためのコマンド．現在ログインしているディレクトリのことをカレントディレクトリと呼ぶ．コマンド名pwdはPrint Working Directoryに由来する．
＼end{itemize}
＼item ＼textbf{ls}
＼begin{itemize}
...
＼section{設定ファイル}＼label{inputfile}
＼subsection{INCAR}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=7cm]{./Figure/INCAR.jpg}
＼caption{INCAR ファイル．}
＼label{INCAR}
＼end{center}
＼end{figure}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=13.0cm]{./Figure/POSCAR1.jpg}
＼caption{POSCAR ファイル．}
＼label{POSCAR1}
＼end{center}
＼end{figure}
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=10.0cm]{./Figure/Sicrystal.jpg}
＼caption{Siのダイヤモンド構造}
＼label{Si}
＼end{center}
＼end{figure}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=14.0cm]{./Figure/POSCAR2.jpg}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=4.0cm]{./Figure/KPOINTS.jpg}
...
＼begin{figure}[htbp]
＼begin{center}
＼includegraphics[width=18.0cm]{./Figure/POTCAR.jpg}
