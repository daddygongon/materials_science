...
しかし作為的に格子定数を変化させ，各温度における最安定構造を検証することによって，熱膨張を求めることが出来る．
...
\if0
\begin{figure}[htbp] 
\begin{center}\includegraphics[width=7.0cm]{./yamamoto/Figure/SiC_Polytypes.jpg} 
...
これによると温度の上昇とともに，平衡格子定数も増加し，熱膨張を再現していることがわかる．

\begin{figure}[htbp] 
\begin{center}\includegraphics[width=7.0cm]{./yamamoto/Figure/3C_Thermal_Energy_Surface.jpg} 
...
\begin{figure}[htbp] 
\begin{center}\includegraphics[width=15.0cm]{./yamamoto/Figure/SiC_Thermal_Expansion.jpg} 
